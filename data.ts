...
export const ORGANIZATION_LOCAL: TeamMember[] = [
  ...
  { name: "Edson Massayuki Kakuno", institution: "" },
...
export const SCIENTIFIC_COMMITTEE: TeamMember[] = [
  { name: "Alex Matos da Silva Costa", institution: "FaCEN - UNA, San Lorenzo, Paraguay" },
  { name: "Alexandre Beletti Ferreira", institution: "IFSP, Brasil" },
  { name: "Amina Ahmed", institution: "Paraguai" },
  { name: "Aref Kalilo Lima Kzam", institution: "ILATIT - UNILA, Foz do Iguaçu, Brasil" },
  { name: "Danilo Fernández Ríos", institution: "FaCEN - UNA, San Lorenzo, Paraguay" },
  { name: "Danúbia Frasson Furtado", institution: "ILACVN - UNILA, Foz do Iguaçu, Brasil" },
  { name: "Dario Lirussi", institution: "INMeT, Argentina" },
  { name: "Diana Pésole", institution: "Itaipu Binacional, Paraguay" },
  ...
  { name: "Fernando Jose Mendez Gaona", institution: "FaCEN - UNA, San Lorenzo, Paraguay" },
  { name: "Gladis Miriam Aparicio Rojas", institution: "UAO, Calli, Colômbia" },
  { name: "Gustavo Arturo Riveros Godoy", institution: "Itaipu Binacional, Paraguay" },
  { name: "Isac Kiyoshi Fujita", institution: "IFSP, São Paulo, Brasil" },
  { name: "Jean Franciesco Vettorazzi", institution: "ILACVN - UNILA, Foz do Iguaçu, Brasil" },
  { name: "Jefferson Luis Ferrari", institution: "IQ - UFU, Uberlândia, Brasil" },
  { name: "Julieta Beatriz Benitez", institution: "UNaM, Argentina" },
  { name: "Katherina Vizcaychipi", institution: "ANLIS Malbrán, Argentina" },
  { name: "Luis Fernando Q. P. Marchesi", institution: "UTFPR, Ponta Grossa, Brasil" },
  { name: "Maraí de Freitas Maio Vendramine", institution: "USP/ESALQ, Brasil" },
  { name: "Maria Cláudia Gross", institution: "ILACVN - UNILA, Foz do Iguaçu, Brasil" },
  { name: "María Evangelina Vallejos", institution: "IMAM – UnaM, Posadas, Argentina" },
  { name: "María Laura Vera", institution: "IMAM – UnaM, Posadas, Argentina" },
  { name: "Michel Varajão Garey", institution: "ILACVN - UNILA, Foz do Iguaçu, Brasil" },
  { name: "Nanci Ehman", institution: "IMAM – UnaM, Posadas, Argentina" },
  { name: "Raul Jose de Souza", institution: "IFSP, São Paulo, Brasil" },
  { name: "Renata Danielle Adati", institution: "UTFPR, Curitiba, Brasil" },
  { name: "Rodrigo Sequinel", institution: "UFPR, Palotina, Brasil" },
  { name: "Sérgio Yoshinobu Araki", institution: "IFSP, São Paulo, Brasil" },
  { name: "Silvina Gabriela Ramos", institution: "UNaM, Posadas, Argentina" },
