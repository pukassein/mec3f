...
// Using simple SVG icons to avoid external dependencies like lucide-react in this restricted environment
// In a real project, install lucide-react
...
export const PlaneIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M17.8 19.2 16 11l3.5-3.5C21 6 21.5 4 21 3c-1-.5-3 0-4.5 1.5L13 8 4.8 6.2c-.5-.1-.9.2-1.1.6l-1 2.5c-.1.4.1.8.5 1l7.5 3.5-2.5 2.5-3.5-.5c-.4-.1-.8.1-1 .5l-1 1.5c-.2.4 0 .8.4 1l4.5 1.5 1.5 4.5c.2.4.6.6 1 .4l1.5-1c.4-.2.6-.6.5-1l-.5-3.5 2.5-2.5 3.5 7.5c.2.4.6.6 1 .5l2.5-1c.4-.2.7-.6.6-1.1z"/>
  </svg>
);
...
export const HeartPulseIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M19 14c1.49-1.28 3.6-2.34 4.58-2.74a2 2 0 0 0 1.29-2.74l-.15-.38a2 2 0 0 0-2.73-.73c-1.5.89-4.65 3.1-5.34 4.19-2.5 4.19-8 4.19-8 4.19s-2.17 0-4.19-4.2c-.69-1.08-3.84-3.29-5.34-4.18a2 2 0 0 0-2.73.73l-.15.38a2 2 0 0 0 1.29 2.74C5.03 11.66 7.14 12.72 8.63 14"/><path d="M3.5 13.5v7h7"/><path d="M13.5 13.5v7h7"/></svg>
);
...
export const AlertTriangleIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m21.73 18-8-14a2 2 0 0 0-3.46 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z"/><path d="M12 9v4"/><path d="M12 17h.01"/></svg>
);
